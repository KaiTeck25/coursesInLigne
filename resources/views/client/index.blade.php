    ...
    <div class="main-wrapper">
        ...
        <div class="slider-area banner-style-1 bg-image height-940 d-flex align-items-center">
            <div class="container eduvibe-animated-shape">
                        ...
                        <div class="inner">
                            <div class="content">
                                <span class="pre-title" data-sal-delay="150" data-sal="slide-up"
                                    data-sal-duration="800">Excellence in Education</span>
                                <h1 class="title" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                                    Start Better Learning Future From Here</h1>
                                <p class="description" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                                    Learning is a life-long journey that in fact we never find the terminate stop. Stop
                                    searching, enjoy the process.</p>
                                <div class="read-more-btn" data-sal-delay="300" data-sal="slide-up"
                    ...
                    <div class="order-1 order-xl-2 col-lg-12 col-xl-6 banner-right-content">
                        <div class="row g-5">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="edu-card card-type-6 radius-small" data-sal-delay="150" data-sal="slide-up"
                                    data-sal-duration="800">
                                    <div class="inner">
                                        <div class="thumbnail">
                                        ...
                                        <div class="content">
                                            ...
                                            <h6 class="title"><a href="course-details.html">Learning How To Write As A
                                                    Professional Author</a></h6>
                                            <div class="card-bottom">
                                                <p>Nunc laoreet, lectue dapibus maximus sapien and tincidunted nequed
                                                    for an finibu euarcu.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="work-shop" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                                    <div class="inner">
                                        <div class="thumbnail"><img src="assets/images/banner/banner-01/workshop.png"
                                                alt="Workshop Images" /></div>
                                        <div class="content">
                                            <h6 class="title">Design Workshop</h6>
                                            <span class="time">Today at 6:00 am</span>
                                            <div>
                                                <a class="edu-btn btn-secondary btn-small"
                                                    href="event-details.html">Join Now<i
                                                        class="icon-arrow-right-line-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
                    ...
                    <div class="shape shape-6"><img src="assets/images/shapes/shape-05-05.png" alt="Shape Thumb" />
                    </div>
                </div>
                <div class="shape-round"><img src="assets/images/banner/banner-01/shape-27.png" alt="Shape Images" />
                </div>
            </div>
                ...
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="about-image-gallery">
                            ...
                            <div class="shape-image shape-image-1"><img src="assets/images/shapes/shape-04-01.png"
                                    alt="Shape Thumb" /></div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="inner">
                            <div class="section-title" data-sal-delay="150" data-sal="slide-up"
                                data-sal-duration="800">
                            ...
                            <p class="description" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                ...
                                porttitor. Facilisi arcu, nibh vel risus, morbi pharetra.
                            </p>
                            <div class="about-feature-list">
                                <!-- Start Single Feature  -->
                                <div class="our-feature" data-sal-delay="150" data-sal="slide-up"
                                    data-sal-duration="800">
                                    <div class="icon">
                            ...
                            <div class="read-more-btn" data-sal-delay="150" data-sal="slide-up"
                                data-sal-duration="800">
                                <a class="edu-btn" href="#">Know About Us<i
                                        class="icon-arrow-right-line-right"></i></a>
                            </div>
        ...
        <div class="home-one-cat edu-service-area service-wrapper-1 edu-section-gap bg-image">
            <div class="container eduvibe-animated-shape">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center section-title" data-sal-delay="150" data-sal="slide-up"
                            data-sal-duration="800">
                        ...
                        <div class="service-card service-card-1 radius-small">
                            <div class="inner">
                                ...
                                <div class="content">
                                    ...
                                    <p class="description">Lorem Ipsum is simply for this dummy text of the printing
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="text-center row mt--60">
                    <div class="col-lg-12">
        ...
        <div class="edu-course-area eduvibe-home-one-course course-wrapper-1 edu-section-gap bg-color-white">
            <div class="wrapper">
                <div class="container eduvibe-animated-shape">
                            ...
                            <div class="edu-card card-type-2 radius-small">
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        ...
                                        <h6 class="title"><a href="course-details.html">Personal Finance: Financial
                                                Security Thinking
                                                &
                                                Principles</a></h6>
                                        ...
                                        <div class="card-bottom">
                                            <div class="price-list price-style-01">
                                                <div class="price current-price">$29.00 USD</div>
                            ...
                            <div class="edu-card card-type-2 radius-small">
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        ...
                                        <h6 class="title"><a href="course-details.html">Grow Personal Financial
                                                Security Thinking &
                                                Principles</a></h6>
                                        <ul class="edu-meta meta-01">
                                        ...
                                        <div class="card-bottom">
                                            <div class="price-list price-style-01">
                                                <div class="price current-price">$55.00 USD</div>
                                                <div class="price old-price">$65.00 USD</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="edu-card card-type-2 radius-small">
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        ...
                                        <h6 class="title"><a href="course-details.html">Educating Through Christ to
                                                Learn And to Serve</a>
                                        </h6>
                                        <ul class="edu-meta meta-01">
                                        ...
                                        <div class="card-bottom">
                                            <div class="price-list price-style-01">
                                                <div class="price current-price">$46.00 USD</div>
                                                <div class="price old-price">$88.00 USD</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="content">
                                        <div class="card-top">
                                            <div class="author-meta">
                                                <div class="author-thumb">
                                                    <a href="instructor-profile.html">
                                                        <img src="assets/images/instructor/instructor-small/instructor-4.jpg"
                                                            alt="Author Images">
                                        ...
                                        <h6 class="title"><a href="course-details.html">Open Programming Courses for
                                                Everyone: Python</a></h6>
                                        <ul class="edu-meta meta-01">
                                        ...
                                        <div class="card-bottom">
                                            <div class="price-list price-style-01">
                                                <div class="price current-price">$56.00 USD</div>
                                                <div class="price old-price">$65.00 USD</div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="edu-card card-type-2 radius-small">
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        ...
                                        <h6 class="title"><a href="course-details.html">Great Things Come From a
                                                Small Package</a></h6>
                                        <ul class="edu-meta meta-01">
                                        ...
                                        <div class="card-bottom">
                                            <div class="price-list price-style-01">
                                                <div class="price current-price">$45.00 USD</div>
                                                <div class="price old-price">$59.00 USD</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="edu-card card-type-2 radius-small">
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        ...
                                        <h6 class="title"><a href="course-details.html">We Prepare Students for
                                                College And Beyond</a></h6>
                                        <ul class="edu-meta meta-01">
                                            <li><i class="icon-group-line"></i>800 Students</li>
                                        ...
                                        <div class="card-bottom">
                                            <div class="price-list price-style-01">
                                                <div class="price current-price">$39.00 USD</div>
                                                <div class="price old-price">$49.00 USD</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
                        <div class="shape-image shape-image-1">
                            <img src="assets/images/shapes/shape-09.png" alt="Shape Thumb" />
                        </div>
                        <div class="shape-image shape-image-2">
                            <img src="assets/images/shapes/shape-10.png" alt="Shape Thumb" />
                        </div>
                        <div class="shape-image shape-image-3">
                            <img src="assets/images/shapes/shape-11.png" alt="Shape Thumb" />
                        </div>
                        <div class="shape-image shape-image-4">
                            <img src="assets/images/shapes/shape-12.png" alt="Shape Thumb" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="eduvibe-testimonial-one edu-testimonial-area edu-section-gap bg-image">
            <div class="container eduvibe-animated-shape">
                        ...
                        <div
                            ...
                            <div class="single-testimonial">
                                <div class="inner">
                                    <div class="quote-sign">
                                        <img src="assets/images/testimonial/testimonial-01/quote.png"
                                            alt="Quote Images">
                                    </div>
                                    ...
                                    <div class="client-information">
                                        <div class="thumb">
                                            <img src="assets/images/testimonial/testimonial-01/client-01.png"
                                                alt="Client Images">
                                        </div>
                                        <div class="info">
                            ...
                            <div class="single-testimonial">
                                <div class="inner">
                                    ...
                                    <p class="description">“ Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                                        Nemo perferendis accusantium ab temporibus possimus vel atque doloribus at
                                        voluptatum sapiente consectetur, explicabo dicta libero architecto beatae vitae
                                        voluptatibus corporis esse.</p>
                                    <div class="client-information">
                                        <div class="thumb">
                                            <img src="assets/images/testimonial/testimonial-01/client-02.png"
                                                alt="Client Images">
                                        </div>
                                        <div class="info">
                            ...
                            <div class="single-testimonial">
                                <div class="inner">
                                    ...
                                    <p class="description">“ Lorem ipsum, or lipsum as it is sometimes known, is dummy
                                        ...
                                        parts of Cicero's De Finibus.</p>
                                    <div class="client-information">
                                        <div class="thumb">
                                            <img src="assets/images/testimonial/testimonial-01/client-03.png"
                                                alt="Client Images">
                                        </div>
                                        <div class="info">
                ...
                <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
                    <div class="shape-image shape-image-1">
                        <img src="assets/images/shapes/shape-13.png" alt="Shape Thumb" />
                    </div>
                    <div class="shape-image shape-image-2">
                        <img src="assets/images/shapes/shape-13-01.png" alt="Shape Thumb" />
                    </div>
                    <div class="shape-image shape-image-3">
                        <img src="assets/images/shapes/shape-04.png" alt="Shape Thumb" />
                    </div>
                    <div class="shape-image shape-image-4">
                        <img src="assets/images/shapes/shape-02-01.png" alt="Shape Thumb" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container eduvibe-animated-shape">
                ...
                <div class="row g-5 mt--20">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up"
                        data-sal-duration="800">
                        <div
                            class="edu-instructor-grid edu-instructor-3 edu-instructor-3-visible eduvibe-hover-active">
                            <div class="edu-instructor">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="instructor-profile.html">
                ...
                <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
                    <div class="shape-image shape-image-1"><img src="assets/images/shapes/shape-03-03.png"
                            alt="Shape Thumb" /></div>
                    <div class="shape-image shape-image-2"><img src="assets/images/shapes/shape-02-02.png"
                            alt="Shape Thumb" /></div>
                </div>
            </div>
        </div>
        ...
        <div class="edu-feature-area eduvibe-home-one-video edu-section-gap bg-color-white">
            <div class="container eduvibe-animated-shape">
                ...
                <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
                    <div class="shape-image shape-image-1">
                        <img src="assets/images/shapes/shape-14.png" alt="Shape Thumb" />
                    </div>
                    <div class="shape-image shape-image-2">
                        <img src="assets/images/shapes/shape-11-01.png" alt="Shape Thumb" />
                    </div>
                    <div class="shape-image shape-image-3">
        ...
        <div class="edu-newsletter-area newsletter-style-1 edu-section-gap bg-color-primary">
            <div class="container eduvibe-animated-shape">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center inner">
                            <div class="text-center text-white section-title" data-sal-delay="150"
                                data-sal="slide-up" data-sal-duration="800">
                ...
                <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
                    <div class="shape-image shape-image-1">
                        <img src="assets//images/shapes/shape-03-04.png" alt="Shape Thumb" />
                    </div>
                    <div class="shape-image shape-image-2">
                        <img src="assets//images/shapes/shape-16.png" alt="Shape Thumb" />
                    </div>
                    <div class="shape-image shape-image-3">
        ...
        <div class="edu-blog-area eduvibe-home-one-blog edu-section-gap bg-image">
            <div class="container eduvibe-animated-shape">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="read-more-btn text-start text-lg-end">
                            <a class="edu-btn" href="blog-standard.html">Read More Blogs<i
                                    class="icon-arrow-right-line-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-5 mt--30">
                            ...
                            <div class="inner">
                                <div class="content">
                                    <div class="status-group">
                                        <a href="#"
                                            class="eduvibe-status status-05 color-primary w-800">EDUCATION</a>
                                    </div>
                                    <h4 class="title"><a href="blog-details.html">10 Things Successful Which Makes
                                            You
                                            Different From Others</a></h4>
                                    <div class="blog-card-bottom">
                                        <ul class="blog-meta">
                                            <li><i class="icon-calendar-2-line"></i>06 Nov, 2022</li>
                                            <li><i class="icon-user-line"></i>Posted By <a href="#">Admin</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <!-- Start Blog Grid  -->
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12" data-sal-delay="200" data-sal="slide-up"
                        data-sal-duration="800">
