    ...
    <div class="main-wrapper">
                ...
                <div class="row g-5 mt--20">
                                    ...
                                    <div class="contact-address-card-1 website">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                ...
                                                <p><a href="https://themeforest.net" target="_blank">www.theme.net</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="contact-address-card-1 email">
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                ...
                                                <p><a href="mailto:eduvibe@example.com"
                                                        target="_blank">eduvibe@example.com</a></p>
                                                <p><a href="mailto:contact@eduvibe.com"
                                                        target="_blank">contact@eduvibe.com</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <form class="rnt-contact-form rwt-dynamic-form row" id="contact-form" method="POST"
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-lg" id="contact-email"
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" name="contact-phone"
                                        id="contact-phone" placeholder="Phone">
                                </div>
                            </div>
        ...
        <div class="edu-contact-map-area edu-section-gapBottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="google-map alignwide" data-sal="slide-up" data-sal-delay="150"
                            data-sal-duration="800">
